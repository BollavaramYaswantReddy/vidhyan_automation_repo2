...
def test_nav_001(config, login_page):
    url = config["url"]
...
def test_nav_002(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_003(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_004(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_005(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_006(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_007(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_008(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_009(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
...
def test_nav_010(config, login_page):
    url = config["url"]
    school_code = config["school_code"]
    username_or_email = config["username_or_email"]
    password = config["password"]
